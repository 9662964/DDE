...
class LoginViewController: UIViewController {
    ...
    private let usernameEmailField: UITextField = {
       let field =  UITextField()
        ...
        field.layer.cornerRadius = Constructs.cornerRadius
    ...
    private let loginButton: UIButton = {
       let button = UIButton()
        ...
        button.layer.cornerRadius = Constructs.cornerRadius
    ...
    @objc private func didTapPrivacyButton() {
        guard let url = URL(string: "https://www.iljoochae.com") else {
            return
        }
